...
1) The map on the individual thread page should be underneath the topic div on the right. 
	...
	It would be cool if it also scrolled with the screen as you scrolled through the replies on the left
                          -----------------OR--------------------
	If the map was static and instead the replies were inside a scrollable div. This would make the add reply box always visible.
